...
INSERT INTO ITEM (item_name, item_description, item_type, value, rarity, item_image) VALUES
('Llave Roja', 'Una llave misteriosa de color rojo.', 'llave', 100, 'rare', '/imagenes/llave-roja.png'),
('Poción de Vida', 'Una poción que restaura la salud del jugador.', 'pocion', 50, 'common', '/imagenes/pocionVida.png'),
('Poción de Maná', 'Una poción que restaura el maná del jugador.', 'pocion', 50, 'common', '/imagenes/pocionMana.png'),
('Llave Morada', 'Una llave misteriosa de color morado.', 'llave', 150, 'rare', '/imagenes/llave-morada.png'),
('Llave Dorada', 'Una llave de oro que abre cofres especiales.', 'llave', 200, 'epic', '/imagenes/llave-dorada.png'),
('Llave Esqueleto', 'Una llave antigua con forma de esqueleto.', 'llave', 150, 'rare', '/imagenes/llave-esqueleto.png'),
('Llave Lobo', 'Una llave decorada con la forma de un lobo.', 'llave', 100, 'uncommon', '/imagenes/llave-lobo.png'),
('Llave Dragón', 'Una llave poderosa con la figura de un dragón.', 'llave', 300, 'epic', '/imagenes/llave-dragon.png');
